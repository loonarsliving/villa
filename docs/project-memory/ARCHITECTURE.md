...
### Confirmed `villa-api` route surface (read directly from deployed v19, 2026-08-27 — supersedes the older "inferred from client call sites" list; `POST /webhook/cloudbeds` removed same day, see above)
